...
use lsp_types::{GotoDefinitionResponse, InitializeParams, Position, request::GotoDefinition, ServerCapabilities};
use lsp_types::OneOf;
                ...
                match cast::<GotoDefinition>(req) {
                    Ok((id, params)) => {
                        ...
                        let location = lsp_types::Location::new(
                            lsp_types::Url::parse("file:///home/awa/_p43/pap/sample.view.tree").unwrap(),
                            lsp_types::Range::new(Position::new(0, 25), Position::new(0,34))
                        );
